...
export const EditPriceModal = ({handleHideEditPriceForm, selectPrice, EditPrice}) => {
        ...
        return(
            <>
                <form className='editVacForm'>
                    ...
                    <button onClick={handleHideEditPriceForm } className='hideBtn' type='button'>
                        <HighlightOffOutlinedIcon />
                    </button>
                        <input className='EditFormInput' type="text" value={PriceTitle} onChange={handlePriceTitleChange}/>
                        <input className='EditFormInput' type="text" value={PoslugaPrice} onChange={handlePoslugaPriceChange}/>
                    <button   onClick={editPrice} className='confirmEditVac' type='button'>Зберегти</button>
                </form>
