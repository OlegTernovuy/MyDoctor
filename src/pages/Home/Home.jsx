                ...
                <div className='titleName'>
                    ...
                    <div className='appointment'>
                        <div className='someInfo'>
                            <p>Сучасний підхід до лікування вашої дитини. Ми пропонуємо нове бачення лікарні у вашому місті. Найкращі спеціалісти та найшвидше обслуговування. Ми цінуємо кожного пацієнта, який довірив нам своє здоров'я.</p>
                        </div>
                        <div className='buton'>
                            <CenteredModal/>
                        </div>
                ...
                <div className='aboutClinic'>
                    <div className='bgPhoto'>
                        ...
                        <div className='informClinic'>
                            ...
                            <p>Ми віримо, що медицина повинна ставитися до людей з повагою. Професійні лікарі, новітнє обладнання та увага до кожного пацієнта – це і є повага. Створюючи медцентр «Мій лікар», ми хотіли відкрити в Україні лікувально-діагностичний центр нового формату.</p>
                        </div>
                        <div className='tab'>
                            <div className='block square1'>
                                <div>Безпечні <br/>процедури </div>
                                <div><img src={procedyru}/></div>
                            </div>
                            <div className='block square2'>
                                <div>Сучасне<br/> обладнання</div>
                                <div><img src={obladnanny}/></div>
                            </div>
                            <div className='block square3'>
                                <div>Спостерігання<br/> лікарем</div>
                                <div><img src={likar}/></div>
                            </div>
                            <div className='block square4'>
                                <div>Обслуговання<br/> без черг</div>
                                <div><img src={metoduku}/></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <Card className='poslugu'>
                            <Card.Img variant="top" src={doctor} height={100} width={100} />
                                <Card.Body>
                                    ...
                                    <Card.Text >
                                    Надаємо повний спектр амбулаторних послуг сімейної медицини та здійснюємо подальший супровід пацієнтів. Для осіб, що уклали декларацію – послуги сімейного лікаря – БЕЗКОШТОВНІ
                                    </Card.Text>
                                </Card.Body>
                            </Card>
                            <Card className='poslugu'>
                            <Card.Img variant="top" src={laboratory} height={100} width={100} />
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                    Надаємо послуги лабораторних досліджень для дітей та дорослих за доступними цінами, включаючи експрес-діагностику коронавірусної інфекції СOVID-19 (виявлення антитіл та антигенів) 
                                    </Card.Text>
                                </Card.Body>
                            </Card>
                            <Card className='poslugu'>
                            <Card.Img variant="top" src={recipe} height={100} width={100} />
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                    Видаємо увесь спектр медичних документів – лікарняні листи, медичні довідки, міжнародні свідоцтва про вакцинацію від СOVID-19. Також надаємо електронні рецепти за програмою “ДОСТУПНІ ЛІКИ”
                                    </Card.Text>
                                </Card.Body>
                        </Card>
                    </div>
